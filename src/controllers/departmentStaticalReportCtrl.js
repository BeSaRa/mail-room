module.exports = function (app) {
    app.controller('departmentStaticalReportCtrl', function (Reporting,
                                                             helpService,
                                                             langService,
                                                             reportService,
                                                             printService) {
        ...
        self.controllerName = 'departmentStaticalReportCtrl';
        helpService.setHelpTo('department-statical-report');

        self.criteria = new Reporting();
        self.pageHeadTextLangKey = 'menu_item_report_department_statical';
        self.reportType = reportService.reportingTypes.departmentStatical;
