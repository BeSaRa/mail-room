module.exports = function (app) {
    app.controller('employeeDetailsReportCtrl', function (Reporting,
                                                          reportService,
                                                          langService,
                                                          helpService,
                                                          printService) {
        ...
        self.controllerName = 'employeeDetailsReportCtrl';
        helpService.setHelpTo('employee-details-report');

        self.criteria = new Reporting();
        self.pageHeadTextLangKey = 'menu_item_report_employee_details';
        self.reportType = reportService.reportingTypes.employeeDetails;
