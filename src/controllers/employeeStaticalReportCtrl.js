module.exports = function (app) {
    app.controller('employeeStaticalReportCtrl', function (Reporting,
                                                           helpService,
                                                           langService,
                                                           reportService,
                                                           printService) {
        ...
        self.controllerName = 'employeeStaticalReportCtrl';
        helpService.setHelpTo('employee-statical-report');

        self.criteria = new Reporting();
        self.pageHeadTextLangKey = 'menu_item_report_employee_statical';
        self.reportType = reportService.reportingTypes.employeeStatical;
