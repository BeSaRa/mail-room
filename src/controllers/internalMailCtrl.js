module.exports = function (app) {
    app.controller('internalMailCtrl', function (internalMailService,
                                                 $q,
                                                 _,
                                                 mailService,
                                                 helpService,
            ...
            self.controllerName = 'internalMailCtrl';
            helpService.setHelpTo('internal-mails');
            ...
            self.tabsToShow = {
                newMails: {
                    name: 'newMails',
                    key: 'lbl_internal_new_mails'
                },
                sentMails: {
                    name: 'sentMails',
                    key: 'lbl_internal_sent_mails'
                },
                receivedMails: {
                    name: 'receivedMails',
                    key: 'lbl_internal_received_mails'
                }
            };
            ...
            self.openAddMailDialog = function ($event) {
                internalMailService.controllerMethod.addDialog(self.grid.newMails, $event);
            };
            ...
            self.viewMail = function (mail, grid, $event) {
                internalMailService.controllerMethod.editDialog(mail, grid, true, $event);
            };
            ...
            self.openEditMailDialog = function (mail, grid, $event) {
                internalMailService.controllerMethod.editDialog(mail, grid, false, $event);
            };
            ...
            self.grid = {
                ...
                newMails: {
                    ...
                    columns: {
                        ...
                        priority: {
                            ...
                            sortKey: function () {
                                if (gridService.isGridServerScope(self.grid.newMails.sortScope)) {
                                    return 'priorityTypeLookup' + 'Embedded.' + (langService.current + 'Name');
                                }
                                return self.getSortingKey('priorityTypeLookup', 'Lookup');
                            },
                            hide: true
                    ...
                    searchCallback: function () {
                        var searchedRecords = mailService.searchMailGridData(self.grid.newMails, self.newMailsCopy, internalMailService.totalRecords);
                    ...
                    sortCallback: function (sortKey) {
                        if (gridService.isGridServerScope(self.grid.newMails.sortScope)) {
                            ...
                            if (self.grid.newMails.filterGridCriteria.criteria) {
                                ...
                                internalMailService._filterCallback(self.grid.newMails, lookupService.statusTypesKeys.new)
                                    .then(function (result) {
                    ...
                    filterGridCallback: function ($event) {
                        var defer = $q.defer();
                        internalMailService.controllerMethod.filterGridDialog(lookupService.statusTypesKeys.new, self.grid.newMails, $event)
                            .then(function (result) {
                    ...
                    reload: function (pageNumber, $event) {
                        ...
                        if (self.grid.newMails.filterGridCriteria.criteria) {
                            internalMailService._filterCallback(self.grid.newMails, lookupService.statusTypesKeys.new, $event)
                                .then(function (result) {
                            ...
                            internalMailService.loadMails(lookupService.statusTypesKeys.new, self.grid.newMails, $event)
                                .then(function (result) {
                                    loadDefer.resolve(result);
                                })
                                .catch(function (error) {
                ...
                sentMails: {
                    ...
                    sortCallback: function (sortKey) {
                        if (gridService.isGridServerScope(self.grid.sentMails.sortScope)) {
                            ...
                            if (self.grid.sentMails.filterGridCriteria.criteria) {
                                ...
                                internalMailService._filterCallback(self.grid.sentMails, lookupService.statusTypesKeys.sent)
                                    .then(function (result) {
                    ...
                    searchText: '',
                    searchCallback: function () {
                        var searchedRecords = mailService.searchMailGridData(self.grid.sentMails, self.sentMailsCopy, internalMailService.totalRecords);
                    ...
                    filterGridCallback: function ($event) {
                        ...
                        internalMailService.controllerMethod.filterGridDialog(lookupService.statusTypesKeys.sent, self.grid.sentMails, $event)
                            .then(function (result) {
                                counterService.loadCounters();
                                self.grid.sentMails.selectedRecords = [];
                                // result will contain only records with this status but to assign to variable, call setMailsByStatusType method
                    ...
                    reload: function (pageNumber, $event) {
                        ...
                        if (self.grid.sentMails.filterGridCriteria.criteria) {
                            internalMailService._filterCallback(self.grid.sentMails, lookupService.statusTypesKeys.sent, $event)
                                .then(function (result) {
                                    loadDefer.resolve(result);
                                })
                                .catch(function (error) {
                            ...
                            internalMailService.loadMails(lookupService.statusTypesKeys.sent, self.grid.sentMails, $event)
                                .then(function (result) {
                                    loadDefer.resolve(result);
                                })
                                .catch(function (error) {
                ...
                receivedMails: {
                    ...
                    sortCallback: function (sortKey) {
                        if (gridService.isGridServerScope(self.grid.receivedMails.sortScope)) {
                            ...
                            if (self.grid.receivedMails.filterGridCriteria.criteria) {
                                ...
                                internalMailService._filterCallback(self.grid.receivedMails, lookupService.statusTypesKeys.received)
                                    .then(function (result) {
                    ...
                    searchCallback: function () {
                        ...
                        var searchedRecords = mailService.searchMailGridData(self.grid.receivedMails, self.receivedMailsCopy, internalMailService.totalRecords);
                    ...
                    filterGridCallback: function ($event) {
                        ...
                        internalMailService.controllerMethod.filterGridDialog(lookupService.statusTypesKeys.received, self.grid.receivedMails, $event)
                            .then(function (result) {
                                counterService.loadCounters();
                                self.grid.receivedMails.selectedRecords = [];
                                // result will contain only records with this status but to assign to variable, call setMailsByStatusType method
                    ...
                    reload: function (pageNumber, $event) {
                        ...
                        if (self.grid.receivedMails.filterGridCriteria.criteria) {
                            internalMailService._filterCallback(self.grid.receivedMails, lookupService.statusTypesKeys.received, $event)
                                .then(function (result) {
                                    loadDefer.resolve(result);
                                })
                                .catch(function (error) {
                            ...
                            internalMailService.loadMails(lookupService.statusTypesKeys.received, self.grid.receivedMails, $event)
                                .then(function (result) {
                                    loadDefer.resolve(result);
                                })
                                .catch(function (error) {
