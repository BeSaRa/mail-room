module.exports = function (app) {
    app.controller('mailActionDetailsReportCtrl', function (Reporting,
                                                            reportService,
                                                            langService,
                                                            helpService,
                                                            printService) {
        ...
        self.controllerName = 'mailActionDetailsReportCtrl';
        helpService.setHelpTo('mail-action-details-report');

        self.criteria = new Reporting();
        self.pageHeadTextLangKey = 'menu_item_report_mail_action_details';
        self.reportType = reportService.reportingTypes.mailActionDetails;
