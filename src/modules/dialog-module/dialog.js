module.exports = function (app) {
    app.service('dialog', function ($mdDialog, mailRoomTemplate, $q, $sce, langService, $rootScope) {
        'ngInject';
        var self = this;
        ...
        function prepareDialog(type, content, cancelButton, escapeToCancel, event, hideIcon) {
            ...
            return {
                ...
                locals: {
                    content: content,
                    cancelButton: cancelButton || (type !== 'confirm' ? langService.get('btn_close') : langService.get('lbl_no')),
                    acceptButton: escapeToCancel || langService.get('lbl_yes'),
