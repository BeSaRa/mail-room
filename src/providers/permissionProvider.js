module.exports = function (app) {
     ...
     */
    app.provider('permission', function () {
        'ngInject';
         ...
         * @return {{getMenuPermissions: (permissionProvider.getMenuPermissions|*), getAllMenuPermissions: (permissionProvider.getAllMenuPermissions|*)}}
         */
        self.$get = function () {
            'ngInject';
            return {
